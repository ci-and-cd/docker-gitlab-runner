...
export IMAGE_NAME=${IMAGE_NAME:-gitlab-runner}
export IMAGE_TAG=${IMAGE_ARG_VERSION:-10.5.0}-bionic_${IMAGE_ARG_LOCALE:-en_US}.${IMAGE_ARG_ENCODING:-UTF-8}_${IMAGE_ARG_TZ_AREA:-Etc}.${IMAGE_ARG_TZ_ZONE:-UTC}
